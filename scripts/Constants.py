...
# Model training
MODEL_PRED_FRAMES = 32
MODEL_ERROR_LOWEST_MULTIPLIER = 8
MODEL_TRAINING_GPU_MEM_LIM = 4096
...
UPDATE_PROGRESS_BAR_FREQ = 1
BETWEEN_EPOCH_DELAY = 0

# Sensor Readings Buffer
SENSOR_BUFFER_ZEROING_SECONDS = 3
DEFAULT_BUFFER_LEN_SEC = 2

# Hand controller server constants
MODEL_MIN_VAL = -1000000
MODEL_MAX_VAL = 1000000
